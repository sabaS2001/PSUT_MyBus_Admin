...
class MarjBusSchedule extends StatefulWidget {
  const MarjBusSchedule({super.key});

  @override
  State<MarjBusSchedule> createState() => _MarjBusScheduleState();
}

class _MarjBusScheduleState extends State<MarjBusSchedule> {
